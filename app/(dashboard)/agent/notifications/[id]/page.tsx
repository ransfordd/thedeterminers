...
export default async function AgentNotificationDetailPage({ params }: Props) {
  ...
  return (
    <>
      <PageHeader
        ...
        backHref="/agent/notifications"
        variant="primary"
      />
      <NotificationDetailView notification={notification} backHref="/agent/notifications" />
    </>
  );
}
