...
export default async function AgentPlaceholderPage({
  ...
  const title = slug.length ? slug.map((s) => s.charAt(0).toUpperCase() + s.slice(1)).join(" / ") : "Agent";
  ...
  return (
    <div className="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-8 text-center">
      ...
      <a href="/agent" className="inline-block mt-4 text-sm font-medium text-blue-600 dark:text-blue-400 hover:underline">
