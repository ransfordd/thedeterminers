    ...
    <>
      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <StatCard icon={<i className="fas fa-piggy-bank text-blue-600" />} value={formatCurrency(data.totalSusuCollected)} label="Total Susu Collected" variant="primary" />
          <StatCard icon={<i className="fas fa-money-bill-wave text-green-600" />} value={formatCurrency(data.totalLoanCollected)} label="Total Loan Collected" variant="success" />
          ...
          <StatCard icon={<i className="fas fa-coins text-cyan-600" />} value={formatCurrency(data.commissionEarned)} label="Commission Earned" variant="info" />
        </div>
      </ModernCard>
    </>
  );
