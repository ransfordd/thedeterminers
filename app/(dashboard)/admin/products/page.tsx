...
export default async function AdminProductsPage() {
  ...
  const [products, display] = await Promise.all([getLoanProducts(), getCurrencyDisplay()]);
  const columns = [
    ...
    { key: "range", header: "Amount Range", render: (r: ProductRow) => `${formatCurrencyFromGhs(r.minAmount, display)} - ${formatCurrencyFromGhs(r.maxAmount, display)}` },
