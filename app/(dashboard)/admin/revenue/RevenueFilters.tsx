...
export function RevenueFilters({
  ...
  const formKey = `${fromDate}-${toDate}-${transactionType}`;
  ...
  return (
    ...
    >
      ...
      <div className="flex gap-2">
        ...
        <a
          href="/admin/revenue"
          className="px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 text-sm hover:bg-gray-50 dark:hover:bg-gray-800 inline-flex items-center"
        >
          Reset
        </a>
      </div>
