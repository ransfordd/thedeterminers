...
export default async function AdminApplicationsPage() {
  ...
  const [applications, currency] = await Promise.all([getLoanApplicationsList(), getCurrency()]);
  ...
  const columns = [
    ...
    { key: "requestedAmount", header: "Amount", render: (r: AppRow) => formatCurrency(r.requestedAmount, currency) },
