...
import { payLoanFromSavings, type SavingsActionState } from "@/app/actions/savings";
...
export function PayLoanForm({
  ...
  if (state?.success) {
    return (
      <div className="rounded-lg border border-green-200 dark:border-green-800 bg-green-50 dark:bg-green-950/30 p-4">
        ...
        <p className="text-sm text-green-700 dark:text-green-300 mt-1">The amount has been applied to your loan from savings.</p>
  ...
  return (
    <form action={formAction} className="space-y-4">
      ...
      <button
        type="submit"
        className="inline-flex items-center gap-2 px-4 py-2 rounded-lg font-medium text-white bg-amber-600 hover:bg-amber-700 dark:bg-amber-700 dark:hover:bg-amber-600 transition-colors"
      >
