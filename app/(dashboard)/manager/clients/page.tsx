...
import { ClientActions } from "@/app/(dashboard)/admin/clients/ClientActions";
...
export default async function ManagerClientsPage({
  ...
  const columns = [
    ...
    { key: "actions", header: "Actions", render: (r: ClientRow) => <ClientActions row={r} isAdmin={false} returnTo="/manager/clients" /> },
  ];
